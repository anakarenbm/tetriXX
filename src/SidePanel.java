...
public class SidePanel extends JPanel {
    ...
    /**
     * Paints the updated levels, controls, score and additional info.
     *
	 ...
	 * Draw the "Stats" category.
        ...
        g.drawString("Level: " + tetris.getLevel(), LARGE_INSET, offset += 
                TEXT_STRIDE);
    ...
    */
    public void drawControls(Graphics g, int offset){
        ...
        g.setFont(SMALL_FONT);
        g.drawString("Left Arrow - Move Left", LARGE_INSET, offset += 
                TEXT_STRIDE);
        g.drawString("Right Arrow - Move Right", LARGE_INSET, offset += 
                TEXT_STRIDE);
        g.drawString("Z - Rotate Anticlockwise", LARGE_INSET, offset += 
                TEXT_STRIDE);
        g.drawString("X - Rotate Clockwise", LARGE_INSET, offset += 
                TEXT_STRIDE);
